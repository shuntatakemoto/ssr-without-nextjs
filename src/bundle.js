...
var _objectAssign = "default" in mod ? mod.default : mod;
var exports1 = {};
(function() {
    'use strict';
    ...
    function forwardRef1(render) {
        {
            if (render != null && render.$$typeof === REACT_MEMO_TYPE) {
                ...
                error1("forwardRef requires a render function but was given %s.", render === null ? "null" : typeof render);
            } else {
                if (render.length !== 0 && render.length !== 2) {
                    error1("forwardRef render functions accept exactly two parameters: props and ref. %s", render.length === 1 ? "Did you forget to use the ref parameter?" : "Any additional parameter will be undefined.");
                }
            }
            if (render != null) {
...
function App() {
    ...
    return exports1.createElement("div", null, count, exports1.createElement("br", null), exports1.createElement("button", {
        type: "button",
        onClick: onClick
    }, "count up"));
}
